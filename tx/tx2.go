...
func (tx *SubstrateTransaction) SignTransaction(privateKey string, signType int) (string, error) {
	...
	ext := types.NewExtrinsic(tx.call)
...
func (tx *SubstrateTransaction) signTx(e *types.Extrinsic, o types.SignatureOptions, privateKey string, signType int) error {
	...
	var signerPubKey types.Address
